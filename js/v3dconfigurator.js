...
$(document).ready(function(){
    ...
    if($('div#container').length) {
        app = new v3d.App('container', {alpha: true}, 
            new myLoader({ container: 'container' }));
        ...
        app.load(url, function() {
            ...
            $("#container").append("<div id=\"Preloader\">Please wait, preloading materials...</div>");
            app.enableControls();
        ...
        function runCode() {
            $(".changeMat").click(function(){
                ...
                if(typeof dataMatSettings === 'undefined' || dataMatSettings == "") {
                    dataMatSettings = {};
                }
